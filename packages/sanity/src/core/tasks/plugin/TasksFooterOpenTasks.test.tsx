...
vi.mock('@sanity/ui', () => {
  ...
  const actual: typeof import('@sanity/ui') = vi.requireActual('@sanity/ui')
...
vi.mock('sanity/router', () => {
  // eslint-disable-next-line @typescript-eslint/consistent-type-imports
  const actual: typeof import('sanity/router') = vi.requireActual('sanity/router')
...
const mockUseMediaIndex = useMediaIndex as vi.Mock
const mockUseTasksStore = useTasksStore as vi.Mock<typeof useTasksStore>
